...
import com.vmall.pojo.TbItemExample.Criteria;
...
public class ItemServiceImpl implements ItemService {
	 ...
	 * @param rows
	 * @return
	 * @see com.vmall.service.ItemService#getItemList(long, long)
	 */
	@Override
	...
	@Override
	public VmallResult createItem(TbItem item, String desc, String itemParam) throws Exception {
		//item补全
		//生成商品ID
		...
		//添加商品描述信息
		VmallResult result = insertItemDesc(itemId, desc);
	 ...
	 * @param desc
	 */
	private VmallResult insertItemDesc(Long itemId, String desc) {
	 ...
	 * @return
	 */
	private VmallResult insertItemParamItem(Long itemId, String itemParam) {
		//创建一个pojo
