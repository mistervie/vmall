...
import com.vmall.order.dao.JedisClient;
...
public class OrderServiceImpl implements OrderService {
	...
	@Override
	public VmallResult createOrder(TbOrder order, List<TbOrderItem> itemList, TbOrderShipping orderShipping) {
		//向订单表插入记录
		//获得订单号
		...
		return VmallResult.ok(orderId.toString());
	}
