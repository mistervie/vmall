...
import com.vmall.portal.pojo.ItemInfo;
...
public class ItemServiceImpl implements ItemService {
	...
	public ItemInfo getItemById(Long itemId) {
		...
		try {
			...
			if (!StringUtils.isBlank(json)) {
				VmallResult taotaoResult = VmallResult.formatToPojo(json, ItemInfo.class);
	...
	public String getItemDescById(Long itemId) {
		try {
			...
			//转换成java对象
			VmallResult taotaoResult = VmallResult.formatToPojo(json, TbItemDesc.class);
			if (taotaoResult.getStatus() == 200) {
	...
	public String getItemParam(Long itemId) {
		try {
			...
			//把json转换成java对象
			VmallResult taotaoResult = VmallResult.formatToPojo(json, TbItemParamItem.class);
			if (taotaoResult.getStatus() == 200) {
